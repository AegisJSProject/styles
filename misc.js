...
export const displays = css`@layer layout.aegisjsproject.displays {
	.block:not([hidden]):not([popover]) {
		display: block;
	}
...
export const positions = css`@layer layout.aegisjsproject.positions {
	.fixed {
		position: fixed;
	}
...
export const floats = css`@layer layout.aegisjsproject.floats {
	.float-left {
		float: left;
	}
...
export const fonts = css`@layer base.aegisjsproject.fonts {
	.system-ui {
...
export const overflows = css`@layer layout.aegisjsproject.overflows {
	.overflow-hidden {
		overflow: hidden;
	}
...
export const colors = css`@layer base.aegisjsproject.colors {
	.current-color {
		fill: currentColor;
	}
...
export const objectFits = css`@layer layout.aegisjsproject.fit {
	.fit-contain {
		object-fit: contain;
	}
...
export const textRules = css`@layer base.aegisjsproject.text {
	.text-align-left {
		text-align: left;
	}
...
export const cursors = css`@layer base.aegisjsproject.cursors {
	.no-pointer-events {
		pointer-events: none;
	}
...
export const utilities = css`@layer utilities.aegisjsproject {
	.clearfix::after {
		clear: both;
		content: '';
		display: block;
...
@layer component.aegisjsproject {
	.card {
...
export const statusBoxes = css`@layer component.aegisjsproject.status-box {
	.status-box {
		padding: 1.2em;
